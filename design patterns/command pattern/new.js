...
So that we can perform the command in mulitple different contexts.
*/
class Calculator {
  constructor() {
    this.value = 0;
...
class AddThenMultiplyCommand {
  //it becomes very easy to add new commands
...
console.log(calculator2.value); // 20
calculator2.undo();
console.log(calculator2.value); // 0
